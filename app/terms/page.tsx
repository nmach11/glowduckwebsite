  ...
  return (
    <div className="min-h-screen bg-white py-16 px-4 sm:px-6 lg:px-8">
      <article className="prose prose-lg max-w-3xl mx-auto">
        ...
        <p>Last updated: December 1st 2025</p>

        <h2>1. Agreement</h2>
        <p>By using GlowDuck (the &quot;App&quot;), you agree to these Terms. If you do not agree, do not use the App.</p>

        <h2>2. Service Description</h2>
        <p>GlowDuck provides habit tracking, weekly skin progress photos, and AI-generated insights about the user&apos;s skin presented in accessible, friendly language (not professional or medical advice). The App may also provide product recommendations that link to third-party retailers, including Amazon.</p>
        ...
        <p><strong>Weekly Plan:</strong> $1.99/week (prices shown in USD and may vary by region/tax).</p>
        <p><strong>Yearly Plan:</strong> $49.99/year, billed annually (equivalent to $4.17/month).</p>
        <p><strong>Auto‑renewal:</strong> Subscriptions renew automatically until cancelled. Manage/cancel anytime in your device&apos;s subscription settings.</p>
        <p><strong>Cancellation:</strong> No partial refunds; you retain access until the current period ends.</p>
        <p><strong>Pricing changes:</strong> Future price changes will be communicated and applied per platform policies.</p>
        ...
        <h2>6. Product Recommendations and Affiliate Links</h2>
        <p><strong>Amazon Affiliate Disclosure:</strong></p>
        <p>GlowDuck is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com.</p>
        <p>The App may display product recommendations that include affiliate links to Amazon.com and other retailers. When you click on these links and make a purchase through Amazon, GlowDuck earns a commission from that purchase. This affiliate relationship helps support the App and allows us to continue providing premium features.</p>
        <p><strong>Important:</strong> We are Amazon affiliates and earn money when you purchase products through the affiliate links provided in the App. This does not affect the price you pay for products, but it does provide us with a commission that helps fund the App&apos;s operations.</p>
        <p><strong>Product Recommendations Disclaimer:</strong></p>
        <p>Product recommendations are generated by AI based on your skin analysis and are for informational purposes only. These recommendations are NOT:</p>
        <ul>
          <li>Medical advice or professional dermatological recommendations</li>
          <li>Guaranteed to work for your specific skin type or condition</li>
          <li>Endorsements of any specific product or brand</li>
          <li>A substitute for professional medical consultation</li>
        </ul>
        <p><strong>Product Safety and Reactions:</strong></p>
        <p>We are NOT responsible for:</p>
        <ul>
          <li>Any adverse reactions, allergies, or side effects you may experience from using any recommended products</li>
          <li>Product quality, safety, or effectiveness</li>
          <li>Product availability, pricing, or shipping from third-party retailers</li>
          <li>Any interactions between recommended products and medications or other products you are using</li>
        </ul>
        <p><strong>Your Responsibility:</strong></p>
        <p>Before using any recommended product, you should:</p>
        <ul>
          <li>Read all product labels, ingredients, and warnings</li>
          <li>Consult with a dermatologist or healthcare professional if you have sensitive skin, allergies, or medical conditions</li>
          ...
          <li>Seek medical attention if you have a severe reaction</li>
        </ul>
        <p><strong>Third-Party Retailers:</strong></p>
        <p>When you click on product links, you will be directed to third-party websites (such as Amazon). We are not responsible for:</p>
        <ul>
          <li>The content, policies, or practices of third-party retailers</li>
          <li>Product availability, pricing, shipping, returns, or customer service</li>
          <li>Any transactions between you and third-party retailers</li>
        </ul>

        <h2>7. Acceptable Use</h2>
        <p>No reverse engineering, scraping, service disruption, or unauthorized access.</p>

        <h2>8. AI Insights Disclaimer</h2>
        ...
        <ul>
          <li>Any injuries, allergic reactions, or adverse effects from using recommended products</li>
          <li>Product defects, recalls, or safety issues</li>
          <li>Any losses or damages resulting from purchases made through affiliate links</li>
          <li>The quality, safety, or effectiveness of any recommended products</li>
        </ul>
        ...
        <ul>
          ...
          <li>Your use of any recommended products, including any adverse reactions or injuries</li>
        </ul>
        ...
        <h2>22. Apple App Store Terms (iOS Users)</h2>
        ...
        <h2>23. Google Play Store Terms (Android Users)</h2>
        ...
        <ul>
          <li>Intellectual Property (Section 9)</li>
          <li>Warranty Disclaimer (Section 10)</li>
          <li>Limitation of Liability (Section 11)</li>
          <li>Indemnification (Section 15)</li>
          <li>Governing Law (Section 16)</li>
          <li>Entire Agreement (Section 20)</li>
          <li>Any other section that by its nature should survive termination</li>
        </ul>

        <h2>26. Export Controls</h2>
        ...
        <h2>27. No Professional Advice</h2>
        <p><strong>Medical Disclaimer (Expanded):</strong></p>
        <p>The Service provides AI-generated insights about skin appearance for informational and motivational purposes only. This is NOT medical advice.</p>
        ...
        <p>For questions about these Terms, please contact us at: <a href="mailto:support@glowduck.app">support@glowduck.app</a></p>
      </article>
    </div>
  )
}